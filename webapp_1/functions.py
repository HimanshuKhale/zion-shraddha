...
def disposal_instructions(party, amount):
    ...
    driver.get("C:/Users/HP/ZION/Zion/Agreements & Invoices/Disposal_Instructions_Form_Edit_12.html")
    ...
    driver.find_element_by_id('pg_2_d1').send_keys(d1)
    ...
    #driver.find_element_by_id('pg2y1').send_keys(y1)
    driver.find_element_by_id('pg2y2').send_keys(y2)
    driver.find_element_by_id('pg2y3').send_keys(y3)
    driver.find_element_by_id('pg2y4').send_keys(y4)
